export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-white mb-2">About Rydon</h1>
      <p className="text-gray-500 mb-8">India&apos;s intercity bike ride pooling platform</p>

      <div className="space-y-6 text-gray-400 leading-relaxed">
        <section>
          <h2 className="text-lg font-semibold text-white mb-2">What is Rydon?</h2>
          <p>
            Rydon connects motorcyclists traveling between cities so they can ride together, share fuel costs, and enjoy
        ...
        <section>
          ...
          <p>
            Every rider on Rydon provides their Aadhaar number and Driving License during registration. This helps ensure
